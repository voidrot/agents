...
Note: ECC intentionally does not rebundle Anthropic's canonical frontend design
guidance. Install the official upstream skill from `anthropics/skills` when you
want that version. This local material belongs to the frontend-design-direction
skill and preserves useful design-direction guidance from #1659.
