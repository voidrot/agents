...
This covers **function parameters**, not method receivers. Receiver rules are currently manual type-design guidance in this repo.
...
-> For pointer vs value **receiver** rules, use manual type-design guidance.
