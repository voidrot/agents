...
description: Full Sentry SDK setup for React Router Framework mode. Use when asked
  to "add Sentry to React Router Framework", "install @sentry/react-router", or configure
  error monitoring, tracing, profiling, session replay, logs, or user feedback for
  a React Router v7 framework app.
license: Apache-2.0
metadata:
  category: sdk-setup
  parent: sentry-sdk-setup
---
> All Skills > sentry-sdk-setup > React Router Framework SDK
...
| Tracing | `references/tracing.md` | Route/request performance visibility needed |
| Profiling | `references/profiling.md` | Server performance analysis needed |
| Session Replay | `references/session-replay.md` | User-facing app |
| Logs | `references/logging.md` | Structured logs/correlation needed |
| User Feedback | `references/user-feedback.md` | In-app feedback flows needed |
| Framework Features | `references/react-router-framework-features.md` | Entry files, wrappers, source maps, startup import strategy |
...
| Ruby | current official Sentry Ruby documentation |
