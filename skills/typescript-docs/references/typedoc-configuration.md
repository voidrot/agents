 ...
 * @see the project's user documentation for more info
 * @see User Guide in the project's `guides/user-management.md`
 */
export interface User {
  // ...
}
...
- UserService (generated file: `user_UserService.UserService.md`)

### Interfaces

- User (generated file: `user_UserService.User.md`)
- CreateUserDto (generated file: `user_UserService.CreateUserDto.md`)

### Type aliases

- UserRole (generated anchor: `user_UserService.md#userrole`)

### Functions

- validateUser (generated anchor: `user_UserService.md#validateuser`)
```
...
\+ new UserService(`config`: UserServiceConfig): UserService (generated docs: `user_UserService.UserService.md`)
...
| :------ | :------ | :------ |
| `config` | UserServiceConfig (generated docs: `user_UserService.UserServiceConfig.md`) | Service configuration |

## Methods

### createUser

▸ createUser(`data`: CreateUserDto): Promise<User> (generated docs: `user_UserService.User.md`)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `data` | CreateUserDto (generated docs: `user_UserService.CreateUserDto.md`) | User creation data |

#### Returns:

Promise<User> (generated docs: `user_UserService.User.md`)
