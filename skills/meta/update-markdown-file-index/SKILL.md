...
description: Use this skill when updating a Markdown file section with a generated index or table of files from a target folder while preserving surrounding content.
---

# Update Markdown File Index

Use this skill for focused update markdown file index work. Keep the active conversation centered on the user's concrete task and load detailed supporting material only when needed.
