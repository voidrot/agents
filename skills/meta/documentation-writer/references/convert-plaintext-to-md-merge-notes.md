# Candidate Merge Notes: convert-plaintext-to-md

Preserved from `skills/.to-sort/convert-plaintext-to-md` for non-duplicate details that may be useful with the canonical skill.
