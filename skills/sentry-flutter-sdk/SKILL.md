...
description: Full Sentry SDK setup for Flutter and Dart. Use when asked to "add Sentry
  to Flutter", "install sentry_flutter", "setup Sentry in Dart", or configure error
  monitoring, tracing, profiling, session replay, or logging for Flutter applications.
...
---
> All Skills > sentry-sdk-setup > Flutter SDK
...
| Tracing & Performance | `references/tracing.md` | Always — navigation, HTTP, DB spans |
| Session Replay | `references/session-replay.md` | iOS/Android user-facing apps |
| Profiling | `references/profiling.md` | iOS/macOS performance-sensitive apps |
| Logging | `references/logging.md` | Structured logging / log-trace correlation |
| Metrics | `references/metrics.md` | Custom business metrics |
| Ecosystem Integrations | `references/ecosystem-integrations.md` | HTTP clients, databases, GraphQL, state management |
...
| .NET backend (`*.csproj`) | current official Sentry .NET documentation |
