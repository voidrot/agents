---
name: breakdown-plan
description: Use this skill when decomposing a project or GitHub issue into an epic, feature, story/enabler, and test hierarchy with dependencies, priorities, and tracking artifacts.
---

# Breakdown Plan

Use this skill for focused breakdown plan work. Keep the active conversation centered on the user's concrete task and load detailed supporting material only when needed.
