...
Migrated from `skills/.to-sort/react18-legacy-context/SKILL.md` into `skills/typescript/react-modernization`.
...
- **`references/react18-legacy-context-single-context.md`** - complete migration for one context (theme, auth, etc.) with provider + class consumer + function consumer
- **`references/react18-legacy-context-multi-context.md`** - apps with multiple legacy contexts (nested providers, multiple consumers of different contexts)
- **`references/react18-legacy-context-context-file-template.md`** - the standard file structure for a new context module
