...
description: Full Sentry SDK setup for Android. Use when asked to "add Sentry to Android",
  "install sentry-android", "setup Sentry in Android", or configure error monitoring,
  tracing, profiling, session replay, or logging for Android applications. Supports
  Kotlin and Java codebases.
license: Apache-2.0
metadata:
  category: sdk-setup
  parent: sentry-sdk-setup
---
> All Skills > sentry-sdk-setup > Android SDK
...
| Tracing & Performance | `references/tracing.md` | Always for Android (Activity lifecycle, network) |
| Profiling | `references/profiling.md` | Performance-sensitive production apps |
| Session Replay | `references/session-replay.md` | User-facing apps (API 26+) |
| Logging | `references/logging.md` | Structured logging / log-to-trace correlation |
| Metrics | `references/metrics.md` | Custom metric tracking (SDK ≥ 8.30.0) |
| Crons | `references/crons.md` | Scheduled jobs, WorkManager check-ins |
| Integration Reference | `references/integrations.md` | Built-in, optional, and Gradle bytecode integrations |
...
| iOS app (`.xcodeproj`) | current official Sentry Apple-platform documentation |
