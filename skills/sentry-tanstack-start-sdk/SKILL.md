...
description: Full Sentry SDK setup for TanStack Start React. Use when asked to "add
  Sentry to TanStack Start", "install @sentry/tanstackstart-react", or configure error
  monitoring, tracing, session replay, logs, or user feedback in a TanStack Start
  React app.
license: Apache-2.0
metadata:
  category: sdk-setup
...
---
> All Skills > sentry-sdk-setup > TanStack Start React SDK
...
| Tracing | `references/tracing.md` | Route/API performance visibility needed |
| Session Replay | `references/session-replay.md` | User-facing app |
| Logs | `references/logging.md` | Structured logs and correlation needed |
| User Feedback | `references/user-feedback.md` | In-app feedback collection needed |
| TanStack Start Features | `references/tanstackstart-features.md` | Server entry, Vite plugin, source maps, runtime startup |
