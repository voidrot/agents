# JavaScript Testing Patterns - Full Guidance

Migrated from `skills/.to-sort/javascript-testing-patterns/SKILL.md`.
...
For full API integration test examples (supertest + PostgreSQL) and database repository integration tests, see [references/advanced-testing-patterns.md](advanced-testing-patterns.md).
...
For complete React component test examples (UserForm, hooks with `renderHook`/`act`), see [references/advanced-testing-patterns.md](advanced-testing-patterns.md).
...
For snapshot testing, coverage configuration, test organization patterns, promise testing, and timer mocking, see [references/advanced-testing-patterns.md](advanced-testing-patterns.md).
