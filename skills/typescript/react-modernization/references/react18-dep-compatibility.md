...
Migrated from `skills/.to-sort/react18-dep-compatibility/SKILL.md` into `skills/typescript/react-modernization`.
...
Read **`references/react18-dep-compatibility-apollo-details.md`** for concurrent mode issues and MockedProvider changes.
...
**react-router v5 → v6 is a SEPARATE migration sprint.** Read `references/react18-dep-compatibility-router-migration.md`.
