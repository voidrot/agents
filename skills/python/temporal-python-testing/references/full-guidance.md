...
**File**: `references/unit-testing.md`
...
**File**: `references/integration-testing.md`
...
**File**: `references/replay-testing.md`
...
**File**: `references/local-setup.md`
...
- "Show me unit testing patterns" → Load `references/unit-testing.md`
- "How do I mock activities?" → Load `references/integration-testing.md`
- "Setup local Temporal server" → Load `references/local-setup.md`
- "Validate determinism" → Load `references/replay-testing.md`
