...
description: Use this skill when converting a feature PRD or architecture brief into a detailed implementation plan with tasks, dependencies, files, and validation steps.
---

# Breakdown Feature Implementation

Use this skill for focused breakdown feature implementation work. Keep the active conversation centered on the user's concrete task and load detailed supporting material only when needed.
