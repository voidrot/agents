...
For the broader a11y testing playbook, see the `accessibility` skill.
...
For any of those, use Playwright Component Testing (component test in real browser) or full E2E. See the `e2e-testing-patterns` skill.
...
- Skills: `react-patterns`, `accessibility`, `e2e-testing-patterns`
- Workflow: use the TDD workflow described above.
