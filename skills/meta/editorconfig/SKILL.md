---
name: editorconfig
description: Use this skill when creating or updating a project .editorconfig by inspecting repository languages, formatting conventions, and editor portability needs.
---

# Editorconfig

Use this skill for focused editorconfig work. Keep the active conversation centered on the user's concrete task and load detailed supporting material only when needed.
