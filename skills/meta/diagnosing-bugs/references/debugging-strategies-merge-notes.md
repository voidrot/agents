# Candidate Merge Notes: debugging-strategies

Preserved from `skills/.to-sort/debugging-strategies` for non-duplicate details that may be useful with the canonical skill.
