...
description: Use this skill when adding educational comments to existing code to explain intent, trade-offs, and non-obvious behavior without cluttering straightforward lines.
---

# Add Educational Comments

Use this skill for focused add educational comments work. Keep the active conversation centered on the user's concrete task and load detailed supporting material only when needed.
