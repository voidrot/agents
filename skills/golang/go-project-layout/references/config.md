...
For complete Cobra+Viper setup, flag binding, precedence rules, and configuration layering, use the framework documentation or project-specific CLI guidance; this repo does not currently include a separate local CLI skill.
