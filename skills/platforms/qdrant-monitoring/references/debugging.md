...
- Use `/collections/{collection_name}/optimizations` endpoint (v1.17+) to check status [Optimization monitoring](https://qdrant.tech/documentation/)
...
- Web UI has an Optimizations tab with timeline view and per-task duration metrics [Web UI](https://qdrant.tech/documentation/)
...
- Estimate expected memory: `num_vectors * dimensions * 4 bytes * 1.5` for vectors, plus payload and index overhead [Capacity planning](https://qdrant.tech/documentation/)
...
- Compare filtered vs unfiltered query times. Large gap means missing payload index. [Payload index](https://qdrant.tech/documentation/)
