...
The examples in `references/details.md` additionally use `tokio-util`, `reqwest`, `sqlx`,
`thiserror`, and `async-stream`; add those crates when using the corresponding patterns.
