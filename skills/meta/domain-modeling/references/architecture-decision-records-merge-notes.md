# Candidate Merge Notes: architecture-decision-records

Preserved from `skills/.to-sort/architecture-decision-records` for non-duplicate details that may be useful with the canonical skill.
