...
|-----------|----------|-------------------|---------------|
| **Spring Boot** | Java | Annotation-driven, layered | Spring Boot Guide |
| **FastAPI** | Python | Async, dependency injection | FastAPI Guide |
| **React** | JavaScript/TypeScript | Component-based, state management | React Guide |
| **Express.js** | JavaScript/TypeScript | Middleware chain, routes | Node.js Guide |
| **Java Servlet** | Java | MVC Model 2, filters | Java Servlet Guide |
| **Python ETL** | Python | Data pipelines, transformations | Python ETL Guide |
...
2. **Validate syntax** using `scripts/extract_mermaid.py document.md --validate`
...
**Full Guide:** Spring Boot Examples
...
**Full Guide:** Node.js/Express Examples
...
**Full Guide:** Java Servlet Examples
...
**Full Guide:** Python ETL Examples
