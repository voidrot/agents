...
func (m *mockUserRepo) GetByID(ctx context.Context, id int64) (*User, bool, error) {
...
func TestUserService_GetUser(t *testing.T) {
    ...
    repo.On("GetByID", mock.Anything, int64(1)).Return(expected, true, nil)
...
func TestUserService_GetUser_NotFound(t *testing.T) {
    ...
    repo.On("GetByID", mock.Anything, int64(999)).Return(nil, false, ErrUserNotFound)
...
→ See `golang-testing` skill for general test patterns and CI configuration.
