# Candidate Merge Notes: backend-patterns

Preserved from `skills/.to-sort/backend-patterns` for non-duplicate details that may be useful with the canonical skill.
