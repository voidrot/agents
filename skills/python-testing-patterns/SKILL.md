...
Install the optional dependency with `pip install freezegun` before using these examples. Use freezegun to control time in tests for predictable time-dependent behavior.
