---
name: diagnose
description: Use this skill when performing a systematic diagnostic scan of an AI workflow across prompt quality, context efficiency, tool health, architecture fitness, and safety.
---

# Diagnose

Use this skill for focused diagnose work. Keep the active conversation centered on the user's concrete task and load detailed supporting material only when needed.
