...
> Verify API details against the current [samber/do documentation](https://do.samber.dev) before implementation.
...
Use the current [samber/do documentation](https://do.samber.dev) for complete API and lifecycle details.
