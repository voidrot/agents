...
description: Use this skill when the user asks to map, document, or onboard into an existing codebase, especially repository-level architecture discovery and codebase knowledge capture.
---

# Acquire Codebase Knowledge

Use this skill for focused acquire codebase knowledge work. Keep the active conversation centered on the user's concrete task and load detailed supporting material only when needed.
...
- Open `references/inquiry-checkpoints.md` when its focused details are needed.
- Open `references/stack-detection.md` when its focused details are needed.
- Use `scripts/scan.py` when you need the preserved supporting material or template.
