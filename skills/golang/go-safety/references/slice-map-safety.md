...
For Go 1.22+ loop variable semantics, use the Go release notes or modernization guidance; this repo does not currently include a separate local modernization skill.
