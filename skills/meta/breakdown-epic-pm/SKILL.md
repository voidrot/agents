...
description: Use this skill when turning a high-level product idea into an epic-level PRD with goals, users, journeys, requirements, scope, and success metrics.
---

# Breakdown Epic Pm

Use this skill for focused breakdown epic pm work. Keep the active conversation centered on the user's concrete task and load detailed supporting material only when needed.
