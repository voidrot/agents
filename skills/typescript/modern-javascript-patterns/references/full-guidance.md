# Modern JavaScript Patterns - Full Guidance

Migrated from `skills/.to-sort/modern-javascript-patterns/SKILL.md`.
...
For common pitfalls (this binding, promise anti-patterns, memory leaks), see [references/advanced-patterns.md](advanced-patterns.md).
