...
description: Use this skill when deriving a focused feature PRD from an epic, including user value, requirements, non-goals, acceptance criteria, and metrics.
---

# Breakdown Feature PRD

Use this skill for focused breakdown feature prd work. Keep the active conversation centered on the user's concrete task and load detailed supporting material only when needed.
