...
- Understand multitenancy patterns [Multitenancy](https://qdrant.tech/documentation/)
...
Read about [Partition by payload](https://qdrant.tech/documentation/) and [Calibrate performance](https://qdrant.tech/documentation/) for best practices on indexing and query performance.


## Number of Tenants is around 100k and more

At this scale, the cluster may consist of several peers.
To localize tenant data and improve performance, use [custom sharding](https://qdrant.tech/documentation/) to assign tenants to specific shards based on tenant ID hash.
...
If some tenants are much larger than others, use [tiered multitenancy](https://qdrant.tech/documentation/) to promote large tenants to dedicated shards while keeping small tenants on shared shards. This optimizes resource allocation and performance for tenants of varying sizes.
