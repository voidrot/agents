...
Migrated from `skills/.to-sort/react18-enzyme-to-rtl/SKILL.md` into `skills/typescript/react-modernization`.
...
- **`references/react18-enzyme-to-rtl-enzyme-api-map.md`** - full mapping: shallow, mount, find, simulate, prop, state, instance, configure
- **`references/react18-enzyme-to-rtl-async-patterns.md`** - waitFor, findBy, act(), Apollo MockedProvider, loading states, error states
