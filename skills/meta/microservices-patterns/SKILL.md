...
description: Use this skill when designing microservice boundaries, event-driven communication, distributed resilience, service ownership, or monolith decomposition plans.
---

# Microservices Patterns

Use this skill for focused microservices patterns work. Keep the active conversation centered on the user's concrete task and load detailed supporting material only when needed.
