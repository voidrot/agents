...
```markdown
Read references/tracing.md for detailed tracing setup steps.
```
...
1. Load the reference: `Read references/<feature>.md`
...
> Use `sentry-react-sdk` or current official Sentry Svelte documentation for full-stack coverage.
```
...
|------|-----------|---------|
| Skill directory | `sentry-<platform>-sdk` | `sentry-go-sdk`, `sentry-react-sdk` |
| Main file | `SKILL.md` | — |
...
- AGENTS.md — General skill authoring guidelines and style rules
