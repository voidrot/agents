# uv Package Manager — full guidance

This reference holds detailed guidance moved out of `SKILL.md` so the skill stays concise. Verify details against current official docs before applying version-sensitive advice.
...
For advanced workflows including Docker integration, lockfile management, performance optimization, tool comparison, common workflows, tool integration, troubleshooting, best practices, migration guides, and command reference, see [advanced-patterns.md](advanced-patterns.md)
