...
- Understand the indexing optimizer [Indexing optimizer](https://qdrant.tech/documentation/)
...
- Use batch upserts (64-256 points per request) [Points API](https://qdrant.tech/documentation/)
- Use 2-4 parallel upload streams

For server-side, optimize Qdrant configuration and indexing strategy:

- Create more shards (3-12), each shard has an independent update worker [Sharding](https://qdrant.tech/documentation/)
- Create payload indexes before HNSW builds (needed for filterable vector index) [Payload index](https://qdrant.tech/documentation/)

Suitable for initial bulk load of large datasets:

- Disable HNSW during bulk load (set `indexing_threshold_kb` very high, restore after) [Collection params](https://qdrant.tech/documentation/)
...
- Check actual progress via optimizations endpoint (v1.17+) [Optimization monitoring](https://qdrant.tech/documentation/)
...
- Reduce `m` (default 16, good for most cases, 32+ rarely needed) [HNSW params](https://qdrant.tech/documentation/)
- Reduce `ef_construct` (100-200 sufficient) [HNSW config](https://qdrant.tech/documentation/)
- Keep `max_indexing_threads` proportional to CPU cores [Configuration](https://qdrant.tech/documentation/)
- Use GPU for indexing [GPU indexing](https://qdrant.tech/documentation/)
...
See [Multi-tenant collections](https://qdrant.tech/documentation/) for details.
...
Read more about disabling extra HNSW links in [documentation](https://qdrant.tech/documentation/)

Read more about ACORN in [documentation](https://qdrant.tech/documentation/)
