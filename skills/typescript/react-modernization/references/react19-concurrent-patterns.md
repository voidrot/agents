...
Migrated from `skills/.to-sort/react19-concurrent-patterns/SKILL.md` into `skills/typescript/react-modernization`.
...
- **`references/react19-concurrent-patterns-react19-use.md`**  the `use()` hook for promises and context
- **`references/react19-concurrent-patterns-react19-actions.md`**  Actions, useActionState, useFormStatus, useOptimistic
- **`references/react19-concurrent-patterns-react19-suspense.md`**  Suspense for data fetching (the new pattern)
