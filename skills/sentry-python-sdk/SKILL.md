...
description: Full Sentry SDK setup for Python. Use when asked to "add Sentry to Python",
  "install sentry-sdk", "setup Sentry in Python", or configure error monitoring, tracing,
  profiling, logging, metrics, crons, or AI monitoring for Python applications. Supports
  Django, Flask, FastAPI, Celery, Starlette, AIOHTTP, Tornado, and more.
license: Apache-2.0
metadata:
  category: sdk-setup
  parent: sentry-sdk-setup
---
> All Skills > sentry-sdk-setup > Python SDK
...
|---------|------------------|-----------|
| Error Monitoring | **Always** — non-negotiable baseline | `references/error-monitoring.md` |
| OTLP Integration | OTel tracing detected — **replaces** native Tracing | `references/tracing.md` |
| Tracing | Django/Flask/FastAPI/AIOHTTP/etc. detected; **skip if OTel tracing detected** | `references/tracing.md` |
| Profiling | Production + performance-sensitive workload; **skip if OTel tracing detected** (requires `traces_sample_rate`, incompatible with OTLP) | `references/profiling.md` |
| Logging | Always (stdlib); enhanced for Loguru | `references/logging.md` |
| Metrics | Business events or SLO tracking needed | `references/metrics.md` |
| Crons | Celery Beat, APScheduler, or cron patterns | `references/crons.md` |
| AI Monitoring | OpenAI/Anthropic/LangChain/etc. detected | `references/ai-monitoring.md` |
...
|---------|---------------|-------------|
| Error Monitoring | `references/error-monitoring.md` | Always (baseline) |
| Tracing | `references/tracing.md` | HTTP handlers / distributed tracing |
| Profiling | `references/profiling.md` | Performance-sensitive production |
| Logging | `references/logging.md` | Always; enhanced for Loguru |
| Metrics | `references/metrics.md` | Business KPIs / SLO tracking |
| Crons | `references/crons.md` | Scheduler / cron patterns detected |
| AI Monitoring | `references/ai-monitoring.md` | AI library detected |

For each feature: `Read references/<feature>.md`, follow steps exactly, verify it works.
