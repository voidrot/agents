...
- Tune HNSW parameters: [Fine-tuning search](https://qdrant.tech/documentation/)
- Enable in-memory quantization: [Scalar quantization](https://qdrant.tech/documentation/)
- Reduce Vector Dimensionality with Matryoshka Models: [Matryoshka Models](https://qdrant.tech/documentation/)
- Use oversampling + rescore for high-dimensional vectors [Search with quantization](https://qdrant.tech/documentation/)
...
- Reduce segment count (`default_segment_number` to 2) [Maximizing throughput](https://qdrant.tech/documentation/)
- Use batch search API instead of single queries [Batch search](https://qdrant.tech/documentation/)
- Enable quantization to reduce CPU cost [Scalar quantization](https://qdrant.tech/documentation/)
- Add replicas to distribute read load [Replication](https://qdrant.tech/documentation/)
...
- Create payload index on the filtered field [Payload index](https://qdrant.tech/documentation/)
- Use `is_tenant=true` for primary filtering condition: [Tenant index](https://qdrant.tech/documentation/)
- Try ACORN algorithm for complex filters: [ACORN](https://qdrant.tech/documentation/)
...
Learn more [here](https://qdrant.tech/documentation/)
