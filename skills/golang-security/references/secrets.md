...
```go
const (
    AWS_ACCESS_KEY    = "DO_NOT_HARDCODE" // DON'T
    AWS_SECRET_KEY    = "DO_NOT_HARDCODE" // DON'T
    DATABASE_PASSWORD = "DO_NOT_HARDCODE" // DON'T
    JWT_SECRET        = "DO_NOT_HARDCODE" // DON'T
)

var config = Config{
    APIKey:     "DO_NOT_HARDCODE", // DON'T
    Secret:     "DO_NOT_HARDCODE", // DON'T
    DatabaseURL: "DO_NOT_HARDCODE", // DON'T
}
```
