...
This covers **function parameters**, not method receivers (see `golang-structs-interfaces` skill for receiver rules).
...
-> See the `golang-structs-interfaces` skill for pointer vs value **receiver** rules.
