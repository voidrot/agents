...
- With scalar quantization: divide by 4 (INT8 reduces each float32 to 1 byte) [Quantization](https://qdrant.tech/documentation/)
- With binary quantization: divide by 32 [Binary quantization](https://qdrant.tech/documentation/)
...
When you hit these limits, see [Horizontal Scaling](horizontal-scaling.md) for guidance on sharding and node planning.
