...
description: Use this skill when designing or refactoring backend architecture with clean architecture, hexagonal architecture, domain-driven design, bounded contexts, or layer dependency rules.
---

# Architecture Patterns

Use this skill for focused architecture patterns work. Keep the active conversation centered on the user's concrete task and load detailed supporting material only when needed.
...
- Open `references/advanced-patterns.md` when its focused details are needed.
